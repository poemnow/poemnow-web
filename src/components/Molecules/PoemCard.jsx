...
function PoemCard({ poem, user, commentCnt }) {
  const { title, content, userId, likeCnt } = poem.poem;
  ...
  return (
    <PoemCardStyle>
      <PoemCardLeftContainer>
        <H5>{title}</H5>
        <PoemCardContent>{content}</PoemCardContent>
        <PoemAuthorContent>{writer}</PoemAuthorContent>
